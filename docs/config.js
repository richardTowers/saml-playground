System.config({
  ...
  map: {
    ...
    "npm:code-mirror@4.0.1": {
      "coffeelint": "npm:coffeelint@0.5.7",
      "csslint": "npm:csslint@0.9.10",
      "diff-match-patch": "npm:diff-match-patch@1.0.0",
      "insert-css": "npm:insert-css@0.0.0",
      "js-yaml": "npm:js-yaml@3.0.2",
      "jshint": "npm:jshint@2.1.11",
      "jsonlint": "npm:jsonlint@1.6.2"
    },
    "npm:codemirror@5.28.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.1",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
